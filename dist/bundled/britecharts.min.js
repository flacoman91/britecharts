...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        getName = function getName(_ref2) {
            ...
            var value = _ref5.value;
            return d3Format.format(labelsNumberFormat)(value) + ' ' + labelsSuffix;
        },
        ...
        function buildAxis() {
            if (isHorizontal) {
                ...
                yAxis2 = d3Axis.axisRight(yScale2).tickFormat(function (d, i) {
                    return d + '%';
                });
            } else {
                xAxis = d3Axis.axisBottom(xScale);
        ...
        function drawAxis() {
            ...
            if (isHorizontal) {
                ...
                svg.select('.y-axis-group.axis-right').attr('transform', 'translate(' + (5 + chartWidth) + ', 0)').call(yAxis2);

                // shift the labels over to the right a bit
                svg.selectAll('.y-axis-group.axis-right .tick text').attr('transform', 'translate(5, 0)').style('fill', function (d) {
