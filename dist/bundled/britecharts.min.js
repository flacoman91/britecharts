...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function drawAnimatedHorizontalRows(rows, bg) {
            if (bg) {} else {
                // Enter + Update
                rows.enter().append('rect').classed('row', true).attr('x', 0).attr('y', chartHeight).attr('height', yScale.bandwidth()).attr('width', function (_ref21) {
                    var value = _ref21.value;
                    return xScale(value);
                }).on('mouseover', function (d, index, rowList) {
                    handleMouseOver(this, d, rowList, chartWidth, chartHeight);
            ...
            if (bg) {
                rows.attr('x', 0).attr('y', function (_ref22) {
                    var name = _ref22.name;
                    return yScale(name);
                }).attr('height', yScale.bandwidth()).attr('fill', '#bebebe').transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('width', '70%');
            } else {

                rows.attr('x', 0).attr('y', function (_ref23) {
                    var name = _ref23.name;
                    return yScale(name);
                }).attr('height', yScale.bandwidth()).attr('fill', function (_ref24) {
                    var name = _ref24.name;
                    return computeColor(name);
                }).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('width', function (_ref25) {
        ...
        function drawAnimatedVerticalRows(rows) {
            // Enter + Update
            rows.enter().append('rect').classed('row', true).attr('x', chartWidth).attr('y', function (_ref26) {
                var value = _ref26.value;
                return yScale(value);
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(rows).attr('x', function (_ref28) {
                var name = _ref28.name;
                return xScale(name);
            }).attr('width', xScale.bandwidth()).attr('fill', function (_ref29) {
                var name = _ref29.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('y', function (_ref30) {
        ...
        function drawVerticalRows(rows) {
            // Enter + Update
            rows.enter().append('rect').classed('row', true).attr('x', chartWidth).attr('y', function (_ref32) {
                var value = _ref32.value;
                return yScale(value);
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(rows).attr('x', function (_ref34) {
                var name = _ref34.name;
                return xScale(name);
            }).attr('y', function (_ref35) {
                var value = _ref35.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref36) {
                var value = _ref36.value;
                return chartHeight - yScale(value);
            }).attr('fill', function (_ref37) {
        ...
        function handleMouseOut(e, d, rowList, chartWidth, chartHeight) {
            ...
            rowList.forEach(function (rowRect) {
                d3Selection.select(rowRect).attr('fill', function (_ref38) {
