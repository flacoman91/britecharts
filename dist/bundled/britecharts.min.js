    ...
    return function module() {
        ...
        function drawAnimatedHorizontalRows(rows) {
            ...
            rows.attr('x', 0).attr('y', function (_ref22) {
                ...
                return yScale(name);
            }).attr('height', yScale.bandwidth()).attr('fill', function (_ref23) {
                var name = _ref23.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('width', function (_ref24) {
        ...
        function drawAnimatedVerticalRows(rows) {
            // Enter + Update
            rows.enter().append('rect').classed('row', true).attr('x', chartWidth).attr('y', function (_ref25) {
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(rows).attr('x', function (_ref27) {
                var name = _ref27.name;
                return xScale(name);
            }).attr('width', xScale.bandwidth()).attr('fill', function (_ref28) {
                var name = _ref28.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('y', function (_ref29) {
                var value = _ref29.value;
                return yScale(value);
        ...
        function drawVerticalRows(rows) {
            ...
            rows.enter().append('rect').classed('row', true).attr('x', chartWidth).attr('y', function (_ref31) {
                ...
                var name = _ref33.name;
                return xScale(name);
            }).attr('y', function (_ref34) {
                var value = _ref34.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref35) {
                var value = _ref35.value;
                return chartHeight - yScale(value);
            }).attr('fill', function (_ref36) {
        ...
        function handleMouseOut(e, d, rowList, chartWidth, chartHeight) {
            ...
            rowList.forEach(function (rowRect) {
                d3Selection.select(rowRect).attr('fill', function (_ref37) {
