    ...
    return function module() {
        ...
        function drawAxis() {
            ...
            if (isHorizontal && enableYAxisRight) {
                ...
                svg.selectAll('.y-axis-group.axis-right .tick text').attr('fill-opacity', function (d) {
        ...
        function drawAnimatedHorizontalRows(rows, bg) {
            ...
            if (bg) {
                rows.attr('x', 0).attr('y', function (_ref26) {
                    ...
                    return yScale(name);
                }).attr('height', yScale.bandwidth()).attr('fill', backgroundColor).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('width', function (_ref27) {
                    var value = _ref27.value;
                    return chartWidth;
                });
            } else {
                rows.attr('x', 0).attr('y', function (_ref28) {
                    var name = _ref28.name;
                    return yScale(name);
                }).attr('height', yScale.bandwidth()).attr('fill', function (_ref29) {
                    var name = _ref29.name;
                    return computeColor(name);
                }).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('width', function (_ref30) {
        ...
        function drawAnimatedVerticalRows(rows) {
            // Enter + Update
            rows.enter().append('rect').classed('row', true).attr('x', chartWidth).attr('y', function (_ref31) {
                var value = _ref31.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref32) {
                var value = _ref32.value;
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(rows).attr('x', function (_ref33) {
                var name = _ref33.name;
                return xScale(name);
            }).attr('width', xScale.bandwidth()).attr('fill', function (_ref34) {
                var name = _ref34.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interRowDelay).ease(ease).attr('y', function (_ref35) {
        ...
        function drawVerticalRows(rows) {
            // Enter + Update
            rows.enter().append('rect').classed('row', true).attr('x', chartWidth).attr('y', function (_ref37) {
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(rows).attr('x', function (_ref39) {
                var name = _ref39.name;
                return xScale(name);
            }).attr('y', function (_ref40) {
                var value = _ref40.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref41) {
                var value = _ref41.value;
                return chartHeight - yScale(value);
            }).attr('fill', function (_ref42) {
        ...
        function handleMouseOut(e, d, rowList, chartWidth, chartHeight) {
            ...
            rowList.forEach(function (rowRect) {
                d3Selection.select(rowRect).attr('fill', function (_ref43) {
