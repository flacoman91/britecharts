(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["test"] = factory(require("d3"));
	else
		root["britecharts"] = root["britecharts"] || {}, root["britecharts"]["test"] = factory(root["d3"]);
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        var margin = {
            ...
            interTestDelay = function interTestDelay(d, i) {
            return animationStepRatio * i;
        },
            highlightTestFunction = function highlightTestFunction(testSelection) {
            return testSelection.attr('fill', function (_ref) {
                var name = _ref.name;
        ...
        function buildScales() {
            ...
            if (isHorizontal) {
                ...
                yScale = d3Scale.scaleBand().domain(data.map(getName)).rangeRound([chartHeight, 0]).padding(betweenTestsPadding);

                yScale2 = d3Scale.scaleBand().domain(data.map(getPctChange)).rangeRound([chartHeight, 0]).padding(betweenTestsPadding);
            } else {
                xScale = d3Scale.scaleBand().domain(data.map(getName)).rangeRound([0, chartWidth]).padding(betweenTestsPadding);
        ...
        function buildSVG(container) {
            if (!svg) {
                svg = d3Selection.select(container).append('svg').classed('britechart test-chart', true);
        ...
        function drawHorizontalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('y', chartHeight).attr('x', 0).attr('height', yScale.bandwidth()).attr('width', function (_ref17) {
            ...
            }).merge(tests).attr('x', 0).attr('y', function (_ref18) {
        ...
        function drawAnimatedHorizontalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('x', 0).attr('y', chartHeight).attr('height', yScale.bandwidth()).attr('width', function (_ref21) {
            ...
            tests.attr('x', 0).attr('y', function (_ref22) {
                var name = _ref22.name;
                return yScale(name);
            }).attr('height', yScale.bandwidth()).attr('fill', function (_ref23) {
                var name = _ref23.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interTestDelay).ease(ease).attr('width', function (_ref24) {
        ...
        function drawAnimatedVerticalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('x', chartWidth).attr('y', function (_ref25) {
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(tests).attr('x', function (_ref27) {
                var name = _ref27.name;
                return xScale(name);
            }).attr('width', xScale.bandwidth()).attr('fill', function (_ref28) {
                var name = _ref28.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interTestDelay).ease(ease).attr('y', function (_ref29) {
        ...
        function drawVerticalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('x', chartWidth).attr('y', function (_ref31) {
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(tests).attr('x', function (_ref33) {
        ...
        function drawTests() {
            ...
            if (isAnimated) {
                tests = svg.select('.chart-group').selectAll('.test').data(dataZeroed);
                ...
                tests = svg.select('.chart-group').selectAll('.test').data(data);
            ...
            // Exit
            tests.exit().transition().style('opacity', 0).remove();
        }
        ...
        function handleMouseOver(e, d, testList, chartWidth, chartHeight) {
            ...
            testList.forEach(function (testRect) {
                if (testRect === e) {
                    return;
                }
        ...
        function handleMouseOut(e, d, testList, chartWidth, chartHeight) {
            ...
            testList.forEach(function (testRect) {
                d3Selection.select(testRect).attr('fill', function (_ref37) {
