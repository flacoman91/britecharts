(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["britecharts"] = root["britecharts"] || {}, root["britecharts"]["test"] = factory();
})(this, function() {
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        _labelsVerticalX = function _labelsVerticalX(_ref8) {
            var name = _ref8.name;
            return xScale(name);
        },
            _labelsVerticalY = function _labelsVerticalY(_ref9) {
            var value = _ref9.value;
            return yScale(value) - labelsMargin;
        },
            _labelsVerticalY1 = function _labelsVerticalY1(_ref10) {
            var pctChange = _ref10.pctChange;
        ...
        function drawAxis() {
            ...
            if (isHorizontal) {
                ...
                svg.selectAll('.y-axis-group.axis-right .tick text').attr('transform', 'translate(10, 0)');

                // based on the data, you can use the up or down arrow icon..
                svg.selectAll('.y-axis-group.axis-right .tick').append('rect').attr('chevron', function (d) {
                    return d > 0 ? 'up' : 'down';
                });
            }
        ...
        function drawHorizontalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('y', chartHeight).attr('x', 0).attr('height', yScale.bandwidth()).attr('width', function (_ref16) {
            ...
            }).merge(tests).attr('x', 0).attr('y', function (_ref17) {
        ...
        function drawAnimatedHorizontalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('x', 0).attr('y', chartHeight).attr('height', yScale.bandwidth()).attr('width', function (_ref20) {
            ...
            tests.attr('x', 0).attr('y', function (_ref21) {
                var name = _ref21.name;
                return yScale(name);
            }).attr('height', yScale.bandwidth()).attr('fill', function (_ref22) {
                var name = _ref22.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interTestDelay).ease(ease).attr('width', function (_ref23) {
        ...
        function drawAnimatedVerticalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('x', chartWidth).attr('y', function (_ref24) {
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(tests).attr('x', function (_ref26) {
                var name = _ref26.name;
                return xScale(name);
            }).attr('width', xScale.bandwidth()).attr('fill', function (_ref27) {
                var name = _ref27.name;
                return computeColor(name);
            }).transition().duration(animationDuration).delay(interTestDelay).ease(ease).attr('y', function (_ref28) {
                var value = _ref28.value;
                return yScale(value);
            }).attr('height', function (_ref29) {
        ...
        function drawVerticalTests(tests) {
            // Enter + Update
            tests.enter().append('rect').classed('test', true).attr('x', chartWidth).attr('y', function (_ref30) {
                ...
                handleClick(this, d, chartWidth, chartHeight);
            }).merge(tests).attr('x', function (_ref32) {
                var name = _ref32.name;
                return xScale(name);
            }).attr('y', function (_ref33) {
                var value = _ref33.value;
                return yScale(value);
            }).attr('width', xScale.bandwidth()).attr('height', function (_ref34) {
                var value = _ref34.value;
                return chartHeight - yScale(value);
            }).attr('fill', function (_ref35) {
        ...
        function handleMouseOut(e, d, testList, chartWidth, chartHeight) {
            ...
            testList.forEach(function (testRect) {
                d3Selection.select(testRect).attr('fill', function (_ref36) {
