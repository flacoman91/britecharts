...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function updateTopicContent(topic) {
            ...
            elementText = tooltipBody.append('text').classed('tooltip-left-text', true).attr('dy', '1em').attr('x', ttTextX).attr('y', ttTextY).attr('font-size', '12px').attr('font-weight', '600').style('fill', tooltipTextColor).text(tooltipLeftText).call(wrapTextWithEllipses, tooltipMaxTopicLength, initialTooltipTextXPosition, 1);

            tooltipRight = tooltipBody.append('text').classed('tooltip-right-text', true).attr('dy', '1em').attr('x', ttTextX).attr('y', ttTextY).attr('font-size', '12px').attr('font-weight', '600').style('fill', tooltipTextColor).text(tooltipRightText);
